...
EXECUTION_ID="5358163105546240"

MY_PN="${PN#google-}"
DESCRIPTION="Google Antigravity 2.0, a dedicated platform to work with agents"
HOMEPAGE="https://antigravity.google/"
BASE_URI="https://storage.googleapis.com/antigravity-public/antigravity-hub/${PV}-${EXECUTION_ID}"
SRC_URI="
	amd64? ( ${BASE_URI}/linux-x64/Antigravity.tar.gz -> ${P}_amd64.tar.gz )
	arm64? ( ${BASE_URI}/linux-arm/Antigravity.tar.gz -> ${P}_arm64.tar.gz )
"
S="${WORKDIR}"
...
pkg_postinst() {
	...
	echo
	ewarn "Package Split Notice:"
	einfo "Beginning with version 2.0, this package only installs the agent component of"
	einfo "Antigravity without the editor view."
	einfo
	einfo "Users looking for the IDE should install:"
	einfo "  dev-util/google-antigravity-ide"
	einfo
	einfo "For the official announcement and details regarding this change, see:"
	einfo "https://antigravity.google/blog/introducing-google-antigravity-2-0"
	echo
